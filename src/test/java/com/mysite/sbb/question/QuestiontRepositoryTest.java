...
class QuestiontRepositoryTest {
    ...
    void t2() {
        ...
        assertThat(question.getSubject().equals("sbb가 무엇인가요?"));
    }
    @Test
    @DisplayName("findBySubjectAndContent")
    void t3() {
        Optional<Question> question = questionRepository.findBySubjectAndContent("sbb가 무엇인가요?", "sbb에 대해서 알고 싶습니다.");
...
//        questionRepository.flush(); // 눈으로 확인하기 위해 flush 사용
    }
